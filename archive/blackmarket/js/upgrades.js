...
var shootRewardUpgrades = [
    new Upgrade("Paper Targets",                                1,         			    function() { shoot[7] *= 5 },   "shoot reward x5"),
    new Upgrade("Paper Targets II",                             1,         			    function() { shoot[7] *= 4 },   "shoot reward x4"),
    new Upgrade("Glow-in-the-Dark Paper Targets",               0,         			    function() { shoot[7] *= 2 },   "shoot reward x2"),
	new Upgrade("Indoor Range",                                 0,         			    function() { shoot[7] *= 1.5 }, "shoot reward x1.5"),
    new Upgrade("Indoor Range II",                              0,        			    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Indoor Range Upgrade",                         0,       			    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Moving Targets",                               0,      			    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Moving Targets II",		                    0,					function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Faster Targets",	                            0,				    function() { shoot[7] *= 2.66 },"shoot reward x2.66"),
    new Upgrade("Personal Trainer",	                            0,				    function() { shoot[7] *= 2.88 },"shoot reward x2.88"),
    new Upgrade("Camera Review System",		                    0, 			    function() { shoot[7] *= 3 },   "shoot reward x3"),
    new Upgrade("Digital Impact System",		                0,			    function() { shoot[7] *= 3 },   "shoot reward x3"),
    new Upgrade("Indoor Range III",		                        0,			    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Indoor Range Armory",		                    0,			function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("200 Acre Outdoor Rifle Range",		            0,		    function() { shoot[7] *= 1.5 }, "shoot reward x1.5"),
    new Upgrade("Rifle Range Tower",		                    0,		    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Tower Laser Range Finder",		                0,		    function() { shoot[7] *= 1.5 }, "shoot reward x1.5"),
    new Upgrade("Tower Digital Impact System",		            0,		    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Indoor Range Bar",		                        0,	    function() { shoot[7] *= 3 },   "shoot reward x3"),
    new Upgrade("250 Acre Close-Quarter Marksman Range",		0,	    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Close-Quarter Range Instructor",		        0,	    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Close-Quarter Range Tower",		            0,	    function() { shoot[7] *= 2 },   "shoot reward x2"),
    new Upgrade("Sniper School",		                        0,	    function() { shoot[7] *= 3 },   "shoot reward x3"),
    new Upgrade("2,000 Acre Sniper Range",		                0,	    function() { shoot[7] *= 3 },   "shoot reward x3"),
    new Upgrade("Sniper Range Digital Overhaul",		        0,	    function() { shoot[7] *= 2 },   "shoot reward x2"),
	new Upgrade("25,000 Acre Range Expansion/Upgrade",          0,     function() { shoot[7] *= 2 },   "shoot reward x2")
];
